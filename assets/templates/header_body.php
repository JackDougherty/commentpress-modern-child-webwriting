...
<div id="switcher">
	<ul>
		<li class="navigation-item"><a class="navigation-button" href="#navigation"><?php _e( 'Contents', 'commentpress-core' ); ?></a></li>			
		<li class="content-item"><a class="content-button" href="#content"><?php _e( 'Read', 'commentpress-core' ); ?></a></li>			
